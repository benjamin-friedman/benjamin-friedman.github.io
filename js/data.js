...
export const discussionsParagraphs = [
    ...
    It vividly resonates in the air with something calm, peaceful, soothing, mysterious, reflective, and nostalgic, and its ability to continuously move ones inner spirit no matter how many times it is listened to can be felt in any arrangement be that with the saxophone in its original orchestral version or arrangements done for the solo piano.
