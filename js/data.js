...
export const discussionsParagraphs = [
    ...
    Amongst them all, he is most well known for compositions like Ständchen (Serenade), Impromptu in G-Flat Major, and Piano Trio No. 2 in E-Flat Major 2nd Movement.
    ...
    Many traverse the circle never making this discovery despite it being in plain view either due to a lack of exposure entirely or never hearing the right songs; the songs that speak to a one's soul in a way unlike anything else can; the songs that express what one feels in a way not capable by one's own volition; the songs that assert what one knows to be true even if not having the ability to articulate it at all, or maybe even not knowing it were true until hearing the music for the first time.
