...
export const discussionsParagraphs = [
    ...
    The name Air on the G String is actually technically a reference to an arrangement of the second movement of Bach's Orchestral Suite No. 3 in D Major, titled Air, by German violinist August Wilhelmj.
    ...
    The beauty and descriptiveness of the name has allowed its popularity to stand the test of time, and as a result the piece is most often referred to as Air on the G String even if Bach's original version Air is being played.
