...
export const discussionsParagraphs = [
    ...
    One of the most beautiful songs ever written is the unreleased track Marry Me from Pirates of the Caribbean: At World's End, and other incredible songs he has composed include Time from Inception, First Steps, No Time for Caution, and Mountains from Interstellar, Final Ascent from No Time to Die, and A Way of Life and A Small Measure of Peace from The Last Samurai.
    ...
    However, if an answer to that question were truly coerced, then it could be stated that Chopin is the greatest, and if not that then at a minimum he would be one of the strongest candidates if not the strongest.
    ...
    What could position Chopin as the greatest is no different than that which positions Zimmer in the arena of soundtrack composing which is the quantity of incredible songs he composed seconded by their emotional heterogeneity.
    ...
    In addition to his nocturnes his over 200 works include twenty-seven preludes (one of them unfinished), twenty-seven etudes, three piano sonatas, and four ballades.
    ...
    Unlike Chopin, many of Liszt's compositions, which surpass 700 in number, traverse outside the world of the solo piano and include organ pieces, choral and vocal works, orchestral works, symphonic poems, and chamber music.
    ...
    It could be proposed that Liebestraum No. 3 is Liszt's crowning achievement for how it wields together the strongest of his abilities which are to create piano songs that are beautiful and piano songs that are technically demanding, and it is one of the immediate examples of why claiming Chopin is <i>the</i> greatest classical piano composer of all time can feel so controversial.
    ...
    A fitting conclusion to the discussion of Liszt could be found with his piano arrangement of Schubert's Der Doppelgänger because it is about the conclusion to life, and is also one of the most beautifully dark and intense pieces of music ever composed.
    ...
    Schubert's original Der Doppelgänger is based on a poem by Heinrich Heine.
    ...
    As previously discussed, a number of his pieces were also inspirations for piano arrangements composed by Liszt, so even after his death he was still able to further contribute to the musical landscape.
    Serenade, though originally composed as a lied wherein poetry is set to classical music, in this particular instance in the form of vocals and piano, is most widely recognized for its version that has the main melody played with strings most commonly with a group of strings or a solo cello, and versions that use the solo cello very often have it partnered with the piano as its accompaniment.
    ...
    It cannot be claimed that Moonlight Sonata 1st Movement is <i>the</i> most beautiful and moving song ever composed on the piano when standing there right next to it in the rain is a song like Chopin's Prelude 4 in E Minor or Nocturne 20 in C-Sharp Minor.
    ...
    Some of Bach's best work includes The Well-Tempered Clavier, Toccata and Fugue in D Minor, Air on the G String, and his famed cello prelude from Cello Suite No. 1 in G Major.
    ...
    The descriptive elegance of the name has allowed its popularity to endure, and as a result the piece is most often referred to as Air on the G String even if Bach's original version Air is being played.
    ...
    <i>Il Vecchio Castello</i> is Italian for <i>The Old Castle</i>, but it is disputed whether the painting actually depicted a castle in Italy or Mussorgky made that attribution himself and the castle resided in a different country.
    ...
    Out of Tchaikovsky's ballets Swan Lake and The Nutcracker come forth some of the most recognizable pieces of all time such as Enchanted Lake, Waltz of the Flowers, or Pas de Deux which has one of the most sensational musical climaxes of all time, and his 1812 Overture which serves to celebrate Russia's defeat of the French invasion led by Napoleon is one of the only songs ever to incorporate actual cannons as is heard in its historic ending.
