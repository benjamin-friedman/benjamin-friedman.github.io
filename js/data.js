...
export const discussionsParagraphs = [
    ...
    However, like Chopin he is most well known for his beautiful, elegant, and technically demanding solo piano pieces, and if it were to be said that Chopin is the greatest classical piano composer of all time then he is maybe the first to come to mind for which it would feel like a betrayal were being enacted upon him.
    ...
    Serenade, though originally composed as a lied wherein poetry is set to classical music, in this particular instance in the form of vocals and piano, is most widely recognized for its version that has the main melody played with strings most commonly with a group of strings or a solo cello.
    ...
    The Well-Tempered Clavier is a series of 96 wonderful preludes and fugues covering all major and minor keys split amongst two books with one of the most famous being the first prelude from Book 1 in C major.
    ...
    Hartman was known for adding human figures to his architectural sketches to adequately capture scale, so in addition to the castle there was a troubadour performing outside the castle which was a composer and performer of lyric poetry in the Occitania region during the High Middle Ages.
    ...
    However, there is evidence to support that it actually was in Italy given that Hartmann had traveled extensively throughout Europe for his work including to Italy, and the Occitania was comprised of territory that later became part of Italy along with France and Spain.
