...
export const discussionsParagraphs = [
    ...
    The second and most famous movement of Pictures at an Exhibition, <i>Il Vecchio Castello</i>, is one of the most hauntingly beautiful pieces ever composed, and if not versed in Italian then upon learning that <i>il vecchio castello</i> translates to <i>the old castle</i> the feeling of the song becomes quite fitting.
    ...
    The melody in measures 7 through 15, beginning with D and G sharp and terminating with B and G sharp one ocatve down, is one of the most beautiful pieces of music ever put to paper by any composer.
    It is impossible to ever get over, and its ability to continuously hit one in the soul no matter how many times it is listened to can be felt in any arrangement be that with the saxophone in its original orchestral version or arrangements done for the solo piano.
    Similar to Liszt's piano arrangment of Schubert's Serenade or piano arrangements of Bach's Air on the G String, the piano arrangement of Il Vecchio Castello demonstrates how musical beauty does not mandate complexity, and some of the most beautiful songs ever composed on the piano are actually birthed from the most simple.
