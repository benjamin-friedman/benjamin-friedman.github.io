...
export const discussionsParagraphs = [
    ...
    Despite his style though, the lifeblood of the Romantic period did at times appear to exist within Mozart as can be heard throughout the majority of Fantasia No. 3 in D Minor like it were a foreshadowing of what was to come, but then towards the end of the song its tone somewhat surprisingly shifts to the Classical period as if Mozart were reminding the listener which period he belongs to.
    This type of juxtaposition does make one think what would have happened if Mozart had lived during the Romantic period and Chopin and Liszt during the Classical period?
    Are they at least partially products of their time and would have composed different music altogether, in this case Chopin and Liszt being the purveyors of musical exquisiteness and perfection and Mozart the purveyor of the expression of emotion, or are they truly unique creatures each destined to have been born on the day that they were born on and to have lived during the time that they lived?
    Intuition leans one towards the latter, but an answer to this question cannot be ultimately known, and it is a puzzling and mind-bending thing to think about.
